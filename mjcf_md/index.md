...
Motrixsim 支持的 MJCF XML 元素参考。`Path` 是本文档的元素唯一主键。标记 [MPEX] 的为 Motphys 扩展。
...
- `mujoco` — Top-level element
  ...
  - [`asset`](./asset.md)
    - `asset/material`, `asset/mesh`, `asset/texture`, `asset/hfield`, `asset/model`
  - [`default`](./default.md)
  ...
  - [`body`](./body.md)
    - `body/inertial`, `body/joint`, `body/freejoint`, `body`, `body/attach`, `body/camera`, `body/frame`, `body/geom`, `body/light`, `body/replicate`, `body/site`
  - [`option`](./option.md)
    - `option/flag`
...
| `asset` | `asset` | `asset.md` | `mujoco` | `asset/material`, `asset/mesh`, `asset/texture`, `asset/hfield`, `asset/model` |
...
| `body` | `body` | `body.md` | `mujoco` | `body/inertial`, `body/joint`, `body/freejoint`, `body`, `body/attach`, `body/camera`, `body/frame`, `body/geom`, `body/light`, `body/replicate`, `body/site` |
