...
Use Damped Least Squares (DLS) method to solve inverse kinematics problem.
    ...
    Args:
       ...
       damping: Damping parameter for regularization (default: 1e-3).
...
|------|-----------|-------------|
| `__new__` | `(cls, max_iter: int = 100, step_size: float = 0.5, tolerance: float = 0.0010000000474974513, damping: float = 0.0010000000474974513) -> DlsSolver` |  |
...
```python
def __new__(cls, max_iter: int = 100, step_size: float = 0.5, tolerance: float = 0.0010000000474974513, damping: float = 0.0010000000474974513) -> DlsSolver
```
